...
const Searchbar = () => {
    ...
    const getClubData = async(clubName)=>{
  ...
  <div className="flex justify-center items-center">
      <h2 className="text-blue-800 text-center text-3xl font-bold">SearchChessBuddy</h2>
    </div>
<div id='search-bar'>
